...
function LandingPage() {
  ...
  return (
      ...
      <div className="home" margin={"auto"}>
        <Marquee style={{height:"5vh", color:"white", backgroundColor:"#eb6071", marginTop:"9vh"}} gradient={false}>Want to upgrade your status and have a good quality of life?<a href="https://forms.gle/FL1suA7EMNfJaE3Z7" style={{color:"black", marginLeft:"0.5vw"}} target="_blank"> Click Here</a></Marquee>
        <NewsCarousel />
        <br/>
        ...
        <Grid container>
          ...
          <Grid item md={8}>
            <div padding={"2vw"} style={{verticalAlign:"center", marginTop:"6vh"}}>
            <p>Slum Administration, Management and rehabilitation is a platform which aims in providing generalized workflow in order to uplift and upgrade the way of living of slum dwellers.
            </p>
            <p>
            Currently, there isn’t any system that links the slum inhabitants and govt together. With SAMAR, we are trying to eradicate that gap present. With this platform, the user can have an overview of all the government schemes, fill grievances and essential facilities.
            On the other hand, the government officials can have a brief look into each and every slum in order to monitor, control and avoid the growth of slums in future.
            The developers can also register themselves and have a look into their project.
            </p>
            </div>
          </Grid>
        </Grid>
        ...
        <Grid container>
          ...
          <Grid item justifyContent={"space-evenly"}>
            <h6>Medicals</h6>
            {medicals.map((e) => (<InfoCard data={e}/>))}
          </Grid>
          <Grid item justifyContent={"space-evenly"}>
            <h6>Schools</h6>
